...
// Collection
import {MapNBCIncome} from '../../imports/api/collections/mapNBCIncome.js';
...
MapNBCIncome.before.insert(function (userId, doc) {
...
MapNBCIncome.before.update(function (userId, doc, fieldNames, modifier, options) {
